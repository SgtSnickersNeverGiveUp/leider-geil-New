...
import { ADMIN_MEDIA_URLS, buildAdminMediaUrlPair } from "./_shared/admin-media-url-contract.mjs";
...
export default async (req) => {
  ...
  if (req.method === "POST") {
    try {
      ...
      const mediaUrls = buildAdminMediaUrlPair(ADMIN_MEDIA_URLS.rosterAvatar, { id: memberId });
