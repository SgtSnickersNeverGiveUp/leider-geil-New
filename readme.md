...
- `npm test` ordnet alle HTML-Einstiege expliziten Script-Grenzen zu und prueft Script-/Stylesheet-Allowlists, Inline-Script-Grenzen, Admin-Script-Reihenfolge sowie rekursiv alle Public-/Admin-Browser-Skripte gegen Boundary-Leaks.
- Der Netlify-Build fuehrt `npm test` aus, damit Admin-/Index-Vermischungen nicht deployed werden koennen.
- Public-/Index-Browsercode darf auch in generiertem Markup keine Inline-Event-Handler oder Admin-Homepage-Selektoren erzeugen; Admin-Homepage-Editoren duerfen keine Public-Index-Widget-Selektoren verwenden.
