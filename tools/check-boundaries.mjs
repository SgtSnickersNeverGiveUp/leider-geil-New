...
assert(
  indexHtml.indexOf("assets/js/shared/content-urls.js") < indexHtml.indexOf("assets/js/index.js"),
  "index.html must load shared content URLs before index.js",
);
assert(
  indexHtml.indexOf("assets/js/shared/roster-slideshow-settings.js") < indexHtml.indexOf("assets/js/roster-slideshow.js"),
  "index.html must load shared roster slideshow settings before roster-slideshow.js",
);

const recruitHtml = read("bewerben.html");
assert(recruitHtml.includes("config.js"), "bewerben.html must load public config");
assert(
  recruitHtml.indexOf("config.js") < recruitHtml.indexOf("assets/js/recruit-form.js"),
  "bewerben.html must load public config before recruit-form.js",
);
...
assert(dashboardHtml.includes("/assets/js/admin-shared.js"), "lg-dashboard.html must load admin-shared.js");
assert(
...
assert(
  dashboardHtml.indexOf("/assets/js/shared/content-urls.js") < dashboardHtml.indexOf("/assets/js/admin-roster.js")
    && dashboardHtml.indexOf("/assets/js/shared/content-urls.js") < dashboardHtml.indexOf("/assets/js/admin-dashboard.js"),
  "lg-dashboard.html must load shared content URLs before admin dashboard scripts",
);
assert(
  dashboardHtml.indexOf("/assets/js/shared/roster-slideshow-settings.js") < dashboardHtml.indexOf("/assets/js/admin-roster.js"),
  "lg-dashboard.html must load shared roster slideshow settings before admin-roster.js",
);
assert(
  dashboardHtml.indexOf("/assets/js/admin-shared.js") < dashboardHtml.indexOf("/assets/js/admin-roster.js")
    && dashboardHtml.indexOf("/assets/js/admin-shared.js") < dashboardHtml.indexOf("/assets/js/admin-dashboard.js"),
  "lg-dashboard.html must load admin-shared.js before admin dashboard scripts",
);
...
assert(indexJs.includes("LG_CONTENT_URLS"), "assets/js/index.js must read public content delivery URLs from shared content-urls.js");
...
assert(
  read("assets/js/roster-slideshow.js").includes("LG_ROSTER_SLIDESHOW_SETTINGS"),
  "public roster slideshow must use shared roster slideshow settings",
);
assert(
  read("assets/js/admin-roster.js").includes("LG_ROSTER_SLIDESHOW_SETTINGS"),
